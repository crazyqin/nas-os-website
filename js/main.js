...
const dictionary = {
  zh: {
    ...
    f5Title: '应用中心',
    f5Text: '相册整理、自动备份、装容器应用……用到再开，不用的先别装，机器更清爽。',
    f6Title: '慢慢扩展就好',
    f6Text: '以后想加功能再加。还在试验的东西默认不出现，不会一打开就眼花缭乱。',
    eyebrowArch: '产品理念',
    ...
    d4Key: '试验功能',
    d4Text: '还在打磨的能力默认不出现，不影响你每天正常用。',
    eyebrowInstall: '快速开始',
    installTitle: '三步开始用 NAS-OS',
    s1Title: '下载',
    s1Text: '打开 GitHub 下载页，选择 v3.24.3（或更新版本）和你电脑匹配的安装包。',
    s2Title: '启动',
    ...
    q4: '最新版本是什么？',
    a4: '当前官网对应 v3.24.3 稳定版。安装包与更新说明见 GitHub 下载页。',
    eyebrowReady: '准备好了吗？',
