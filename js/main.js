...
const dictionary = {
  zh: {
    ...
    heroTitle: '精致私有云。',
    heroText: 'NAS-OS v3.15.0 聚焦存储效率与合规审计：快照调度、去重顾问、固件更新编排、数据保留策略，存储治理一步到位。',
    download: '免费下载',
    start: '5 分钟开始',
    notesAria: '产品特点',
    noteGo: 'v3.15.0',
  ...
  en: {
    ...
    heroText: 'NAS-OS v3.15.0 adds storage efficiency and compliance audit: snapshot scheduling, dedup advisor, firmware update orchestration, and data retention policies in one lightweight interface.',
