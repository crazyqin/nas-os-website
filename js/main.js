...
const dictionary = {
  zh: {
    ...
    heroTitle: '精致私有云。',
    heroText: 'NAS-OS v3.16.0 聚焦智能调度与数据主权：SSD缓存智能调度、云存储成本审计、多媒体海报刮削、电源管理调度、多NAS集群编排、数据主权审计，存储治理迈入AI时代。',
    download: '免费下载',
    start: '5 分钟开始',
    notesAria: '产品特点',
    noteGo: 'v3.16.0',
  ...
  en: {
    ...
    heroText: 'NAS-OS v3.16.0 brings intelligent scheduling and data sovereignty: SSD cache scheduling, cloud cost audit, poster scraping, power management, multi-NAS cluster orchestration, and data sovereignty audit in one lightweight interface.',
