...
const dictionary = {
  zh: {
    ...
    heroTitle: '精致私有云。',
    heroText: 'NAS-OS 专注家庭与小团队：文件、相册、备份、容器与安全管理，都在一个轻巧界面里。',
    download: '免费下载',
    start: '5 分钟开始',
    notesAria: '产品特点',
    noteGo: 'Go 驱动',
    ...
    proofAria: '项目数据',
    proofDeploy: '快速部署',
    proofProtocols: '主流共享协议',
    proofEntry: '统一管理入口',
    proofOpen: '开放自托管',
    featuresTitle: '只保留真正常用的能力。',
    featuresText: '不是把功能写满屏幕，而是把每天会用的事情做顺手。',
    f1Title: '文件与共享',
    f1Text: 'SMB、NFS、WebDAV、FTP/SFTP，多端访问，权限清晰。',
    f2Title: '备份与快照',
    f2Text: '定时备份、版本保留、快照回滚，让误删和故障都有退路。',
    f3Title: '相册与媒体',
    f3Text: '照片时间线、媒体索引、智能整理，家庭资料更好找。',
    f4Title: 'Docker 应用',
    f4Text: '常用服务一键部署，容器状态、日志、更新集中管理。',
    f5Title: '安全与权限',
    f5Text: 'RBAC、双因素认证、审计日志、告警策略，默认更安心。',
    f6Title: '健康与监控',
  ...
  en: {
    ...
    heroText: 'NAS-OS brings files, photos, backups, containers, security, and monitoring into one lightweight interface for homes and small teams.',
    download: 'Free download',
    start: 'Start in 5 minutes',
    notesAria: 'Product highlights',
    noteGo: 'Powered by Go',
    ...
    proofProtocols: 'Sharing protocols',
    proofEntry: 'One control center',
    ...
    f1Text: 'SMB, NFS, WebDAV, FTP/SFTP, clear permissions, and access from every device.',
    f2Title: 'Backup & snapshots',
    f2Text: 'Scheduled backups, version retention, and snapshot rollback when accidents happen.',
    f3Title: 'Photos & media',
    f3Text: 'Photo timelines, media indexing, and smart organization for family archives.',
    f4Title: 'Docker apps',
    f4Text: 'Deploy everyday services in one click, then manage status, logs, and updates centrally.',
    f5Title: 'Security & access',
    f5Text: 'RBAC, two-factor auth, audit logs, and practical alerting from the start.',
