...
const dictionary = {
  zh: {
    ...
    heroTitle: '精致私有云。',
    heroText: 'NAS-OS v3.18.0 带来 27 个新模块：NFS RDMA、iSCSI 硬件卸载、LXC/VM 恢复、SSO 身份中心、API 配额监控、Release 渠道管理与网络安全防护，面向团队与高性能存储场景继续进化。',
    download: '免费下载',
    start: '5 分钟开始',
    notesAria: '产品特点',
    noteGo: 'v3.18.0',
    ...
    f2Title: '备份与快照',
    f2Text: '定时备份、版本保留、快照调度、去重顾问、保留策略与恢复演练，让数据韧性可衡量。',
    f3Title: '搜索与媒体',
  ...
  en: {
    ...
    heroText: 'NAS-OS v3.18.0 adds 27 new modules: NFS RDMA, iSCSI hardware offload, LXC/VM restore, SSO identity center, API quota monitoring, release channel management, and network security for team and high-performance storage workflows.',
    ...
    f2Text: 'Scheduled backups, version retention, snapshot scheduling, dedup advisor, retention policies, and recovery drills.',
