...
const dictionary = {
  zh: {
    ...
    heroTitle: '精致私有云。',
    heroText: 'NAS-OS v3.24.3 完成默认表面收敛：Core 五模块（身份 / 存储 / 网络 / 共享 / 系统）开箱即用；Docker、相册、AI、备份等按需开启。架构分层 Core · Extension · Lab，运行时诚实、安全默认更稳。',
    download: '免费下载',
    start: '5 分钟开始',
    notesAria: '产品特点',
    noteGo: 'v3.24.3',
    ...
    proofAria: '项目数据',
    proofCore: 'Core 模块',
    proofExt: '可配 Extension',
    proofEntry: '测试文件',
    proofOpen: '开放自托管',
    featuresTitle: '默认只开真正核心的能力。',
    featuresText: '不是把功能写满屏幕。默认 Core 开箱能管盘、共享、用户与健康；其余产品能力按需打开。',
    f1Title: '存储与卷',
    f1Text: 'btrfs 卷 / 子卷 / 快照，统一 API /api/v1/storage/*，WebUI 与后端契约一致。',
    f2Title: '文件共享',
    f2Text: 'SMB 与 NFS 为 Core 默认能力；WebDAV / FTP / SFTP 等可在 optional 面启用。',
    f3Title: '身份与安全',
    f3Text: '用户与权限、首次登录强制改密、生产 CSRF、默认监听本机，安全默认更稳。',
    f4Title: 'Core 健康探针',
    f4Text: '/api/v1/system/health 聚合 Core 模块真实 Health()，失败即 unhealthy。',
    f5Title: '可选产品面',
    f5Text: 'Docker、VM、相册、AI、备份、云同步等：设 modules.optional: true 再启用。',
    f6Title: 'Extension · Lab',
    f6Text: '7 个 Extension 按列表加载；Lab 实验能力仅源码保留，不进入默认 nasd 热路径。',
    detailsTitle: '运行时诚实，分层清晰。',
    detailsText: 'v3.22–v3.24 把伪核心收敛进 Lab，生产进程只认 Core 生命周期。',
    d1Key: 'Core',
    d1Text: 'identity · storage · network · sharing · system — 始终启动。',
    d2Key: 'Optional',
    d2Text: 'modules.optional=true 时构造 Docker / Photos / AI / 备份等产品管理器。',
    d3Key: 'Extension',
    d3Text: 'modules.extensions 列表按需挂载 7 个产品扩展。',
    d4Key: 'Lab',
    ...
    q2: '默认会装很多功能吗？',
    a2: '不会。默认只启用 Core（用户、存储、网络、SMB/NFS、系统健康）。Docker / 相册 / AI / 备份等需 modules.optional=true 或配置 extensions。',
    q3: '和群晖/TrueNAS 有什么区别？',
    a3: 'NAS-OS 更强调开源、轻量、可自托管；架构分层诚实（Core / Extension / Lab），差异化能力如本地 AI、WriteOnce 等按需启用，而非默认全开。',
    q4: '最新版本是什么？',
    a4: '当前官网同步版本为 v3.24.3 Stable。详见 GitHub Releases 与仓库 README 的默认交付面说明。',
  ...
  en: {
    ...
    heroText: 'NAS-OS v3.24.3 ships an honest default surface: five Core modules (identity, storage, network, sharing, system) out of the box. Docker, photos, AI, and backups stay optional. Clear Core · Extension · Lab tiers and safer defaults.',
    ...
    proofExt: 'Configurable extensions',
    proofEntry: 'Test files',
    proofOpen: 'Open self-hosting',
    featuresTitle: 'Core by default. More when you need it.',
    featuresText: 'Not a wall of always-on features. Default Core covers disks, shares, users, and health — optional product surfaces load on demand.',
    ...
    f2Text: 'SMB and NFS ship in Core. WebDAV, FTP, and SFTP stay on the optional product surface.',
    ...
    f5Title: 'Optional product surface',
    f5Text: 'Docker, VMs, photos, AI, backup, cloud sync: enable with modules.optional: true.',
    f6Title: 'Extension · Lab',
    f6Text: 'Seven extensions load from modules.extensions. Lab stays source-only — off the default nasd hot path.',
    detailsTitle: 'Honest runtime. Clear tiers.',
    detailsText: 'v3.22–v3.24 demoted pseudo-core into Lab. Production lifecycle is Core-only.',
    d1Key: 'Core',
    d1Text: 'identity · storage · network · sharing · system — always on.',
    d2Key: 'Optional',
    d2Text: 'With modules.optional=true, construct Docker / Photos / AI / backup managers.',
    d3Key: 'Extension',
    d3Text: 'Load seven product extensions from the modules.extensions list.',
    d4Key: 'Lab',
    ...
    a2: 'No. Default Core is users, storage, network, SMB/NFS, and system health. Docker, photos, AI, and backups need modules.optional=true or extensions.',
    q3: 'How is it different from Synology or TrueNAS?',
    a3: 'NAS-OS is open, lightweight, and self-hosted with honest tiers (Core / Extension / Lab). Differentiated features like local AI or WriteOnce are opt-in, not always-on.',
    q4: 'What is the latest version?',
    a4: 'This site tracks v3.24.3 Stable. See GitHub Releases and the project README default-surface section.',
...
function applyLanguage(lang) {
  ...
  document.querySelector('meta[name="description"]')?.setAttribute(
    'content',
    lang === 'zh'
      ? 'NAS-OS v3.24.3：默认 Core 五模块（身份/存储/网络/共享/系统），可选 Docker、相册、AI 与扩展。开源、轻量、可自托管的家用 NAS。'
      : 'NAS-OS v3.24.3: Core-first default (identity, storage, network, sharing, system). Optional Docker, photos, AI, and extensions. Lightweight open-source home NAS.'
  );
