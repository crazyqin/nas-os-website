...
const dictionary = {
  zh: {
    ...
    heroTitle: '精致私有云。',
    heroText: 'NAS-OS v3.17.0 聚焦数据分层与恢复置信：ZFS数据集分层调度、TCO可视化仪表板、AI照片故事生成、FEC网络纠错配置、合规审计工作流编排、勒索恢复置信度评估，存储治理持续进化。',
    download: '免费下载',
    start: '5 分钟开始',
    notesAria: '产品特点',
    noteGo: 'v3.17.0',
  ...
  en: {
    ...
    heroText: 'NAS-OS v3.17.0 brings data tiering and restore confidence: ZFS dataset tiering, TCO dashboard, AI photo stories, FEC network config, compliance audit orchestration, and ransomware restore confidence scoring in one lightweight interface.',
