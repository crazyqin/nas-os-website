...
const dictionary = {
  zh: {
    ...
    heroTitle: '精致私有云。',
    heroText: 'NAS-OS v3.13.0 聚焦 WebShare 搜索顾问：文件分享、索引覆盖、外链安全、快照保护，都在一个轻巧界面里。',
    download: '免费下载',
    start: '5 分钟开始',
    notesAria: '产品特点',
    noteGo: 'v3.13.0',
  ...
  en: {
    ...
    heroText: 'NAS-OS v3.13.0 adds WebShare search guidance for sharing, index coverage, link security, and snapshot protection in one lightweight interface.',
